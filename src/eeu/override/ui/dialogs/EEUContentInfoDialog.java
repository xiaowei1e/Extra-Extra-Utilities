package eeu.override.ui.dialogs;
...
import eeu.override.ui.OverrideUI;
...
public class EEUContentInfoDialog extends ContentInfoDialog implements OverrideUI {
    ...
    public void show(UnlockableContent content) {
        ...
        if (content.description != null) {
            ...
            FLabel f = new FLabel("[lightgray]" + content.displayDescription());
            table.add(f).wrap().fillX().padLeft(any ? 10 : 0).width(500f).padTop(any ? 0 : 10).left();
            f.skipToTheEnd();
            table.row();
